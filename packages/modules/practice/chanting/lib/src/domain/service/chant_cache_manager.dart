...
//     await chantCacheRepository.ensureCacheDirectories();
...
//       final chant = await chantRepository.read(contentId);
...
//     final destinationPath = await chantCacheRepository.buildCacheFilePath(
//       contentId: chant.id,
//       assetType: assetType,
//       version: version,
//     );
...
//       if (existing != null) {
//         await chantCacheRepository.deleteIfExists(existing.localFilePath);
//       }
...
//       );
//       await chantCacheRepository.upsertEntry(pendingEntry);

//       // Start the download task for the asset
//       final downloadTask = await chantCacheRepository.downloadToFile(
//         storagePath: storagePath,
...
//             if (existing == null) {
//               chantCacheRepository.deleteIfExists(destinationPath);
//             }
...
//       CachedAssetType.values.byName(pendingEntry.assetType),
//     );
//     final downloadedHash = await chantCacheRepository.sha256FromFile(destinationPath);
//     final downloadedBytes = await chantCacheRepository.fileSize(destinationPath);
...
//   }) async {
//     await chantCacheRepository.markState(
//       contentId: contentId,
//       assetType: type,
//       state: CacheDownloadState.failed,
