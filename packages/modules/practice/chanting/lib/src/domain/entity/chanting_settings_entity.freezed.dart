...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChantingSettingsEntity&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.selectedChants, selectedChants)&&(identical(other.lastUsed, lastUsed) || other.lastUsed == lastUsed));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(selectedChants),lastUsed);
...
class _ChantingSettingsEntity extends ChantingSettingsEntity with DiagnosticableTreeMixin {
  const _ChantingSettingsEntity({required this.id, final  List<String> selectedChants = const <String>[], @DateTimeOrNullConverter() this.lastUsed}): _selectedChants = selectedChants,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChantingSettingsEntity&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._selectedChants, _selectedChants)&&(identical(other.lastUsed, lastUsed) || other.lastUsed == lastUsed));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(_selectedChants),lastUsed);
