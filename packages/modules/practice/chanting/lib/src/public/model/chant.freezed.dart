...
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  final _this = this as Chant;
  return 'Chant(id: ${_this.id}, name: ${_this.name}, metaData: ${_this.metaData}, blurHash: ${_this.blurHash}, order: ${_this.order}, length: ${_this.length})';
}
