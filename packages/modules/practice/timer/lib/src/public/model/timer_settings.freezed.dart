...
class _TimerSettings extends TimerSettings with DiagnosticableTreeMixin {
  const _TimerSettings({@DurationConverter() this.warmup = const Duration(minutes: 1), @DurationConverter() this.duration = const Duration(minutes: 10), this.intervalCount = 0, this.intervalSound = Sound.triangle, this.startingSound = Sound.smallBell, this.endingSound = Sound.smallBell, @DateTimeOrNullConverter() this.lastUsed}): super._();
