...
class ProfileStatsReportUpdaterService with LoggerMixin {

  ProfileStatsReportUpdaterService();

  bool hasLastSession(ProfileStatsReportEntity stats) {
  ...
  int calculateConsecutiveDaysCount(
    ProfileStatsReportEntity stats,
    DateTime currentSessionDate,
  ) {
  ...
  ProfileStatsReportEntity updateConsecutiveDays(
    ProfileStatsReportEntity stats,
    DateTime currentSessionDate,
  ) {
  ...
  ProfileStatsReportEntity updateCompletedDays(
    ProfileStatsReportEntity stats,
    DateTime currentSessionDate,
  ) {
  ...
  ProfileStatsReportEntity updateMilestoneProgressWithSession(
    ProfileStatsReportEntity oldStatsReport,
    ProfileStatsReportEntity updatedStatsReport,
  ...
  ProfileEntity updateProfileStatsWithSession(
    ProfileEntity profile,
    ProfileSessionEntity session,
  ) {

    final ProfileStatsReportEntity oldStatsReport = profile.statsReport;
    ProfileStatsReportEntity updatedStatsReport = oldStatsReport.copyWith();
    ...
    ProfileEntity updatedProfile = profile.copyWith(statsReport: updatedStatsReport);
