...
class SafeImageDetectionException implements Exception {
  final String message;

  const SafeImageDetectionException(this.message);

  @override
  String toString() => 'SafeImageDetectionException: $message';
}
