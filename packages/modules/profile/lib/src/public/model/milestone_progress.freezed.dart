...
mixin _$MilestoneProgress {
 ...
 int get completedDaysCount; int get targetDaysCount; List<ProfileSession> get sessions;
...
@useResult
$Res call({
 int completedDaysCount, int targetDaysCount, List<ProfileSession> sessions
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int completedDaysCount,  int targetDaysCount,  List<ProfileSession> sessions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MilestoneProgress() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int completedDaysCount,  int targetDaysCount,  List<ProfileSession> sessions)  $default,) {final _that = this;
switch (_that) {
case _MilestoneProgress():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int completedDaysCount,  int targetDaysCount,  List<ProfileSession> sessions)?  $default,) {final _that = this;
switch (_that) {
case _MilestoneProgress() when $default != null:
return $default(_that.completedDaysCount,_that.targetDaysCount,_that.sessions);case _:
  return null;
...
@override@JsonKey() final  int targetDaysCount;
 final  List<ProfileSession> _sessions;
@override@JsonKey() List<ProfileSession> get sessions {
