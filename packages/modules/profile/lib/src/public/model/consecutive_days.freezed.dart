...
bool operator ==(Object other) {
  final _this = this as ConsecutiveDays;
...
String toString() {
  final _this = this as ConsecutiveDays;
  return 'ConsecutiveDays(current: ${_this.current}, longest: ${_this.longest}, startedAt: ${_this.startedAt}, lastChecked: ${_this.lastChecked})';
}
...
class _ConsecutiveDays implements ConsecutiveDays {
  const _ConsecutiveDays({this.current = 0, this.longest = 0, @DateTimeOrNullConverter() this.startedAt, @DateTimeOrNullConverter() this.lastChecked});
