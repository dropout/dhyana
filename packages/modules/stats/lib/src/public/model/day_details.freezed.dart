...
class _DayDetails extends DayDetails {
  const _DayDetails({required this.id, required this.startDate, final  List<StatsSession> sessions = const [], this.consecutiveDaysCount = 0}): _sessions = sessions,super._();
