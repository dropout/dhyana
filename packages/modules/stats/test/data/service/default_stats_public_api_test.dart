...
void main() {
  ...
  group('DefaultStatsPublicApi.logSessionStatistics', () {
    test(
      'loads profile and logs mapped session with consecutive day count',
      () async {
        ...
        final expectedEntity = session.toDomain();
        ...
        when(
          () => statisticsRepository.logSessionStats(
            profileId,
            expectedEntity,
            6,
          ),
    ...
    test('forwards profile api errors and skips repository logging', () async {
      ...
      verifyNever(
        () => statisticsRepository.logSessionStats(any(), any(), any()),
      );
    });
  });
  ...
  group('DefaultStatsPublicApi.queryBuckets', () {
    test(
      'queries repository with mapped granularity and maps result to api buckets',
      () async {
