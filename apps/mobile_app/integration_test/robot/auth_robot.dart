...
class AuthRobot {
  ...
  Future<void> autoSigninWithEmailAndPassword() async {
    ...
    await tester.pumpUntilFound(find.byKey(Key('login_with_email_and_password_screen')));
  ...
  Future<void> signinWithEmailAndPassword({
    ...
    await tester.pumpAndSettle();
    expect(find.byKey(Key('login_with_email_and_password_screen')), findsOneWidget);
  }
