...
$YearQueryOptionsCopyWith<YearQueryOptions> get copyWith => _$YearQueryOptionsCopyWithImpl<YearQueryOptions>(this as YearQueryOptions, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is YearQueryOptions&&(identical(other.from, from) || other.from == from)&&(identical(other.to, to) || other.to == to)&&(identical(other.limit, limit) || other.limit == limit));
}
...
abstract mixin class $YearQueryOptionsCopyWith<$Res>  {
  factory $YearQueryOptionsCopyWith(YearQueryOptions value, $Res Function(YearQueryOptions) _then) = _$YearQueryOptionsCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _YearQueryOptions value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _YearQueryOptions value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _YearQueryOptions value)?  $default,){
final _that = this;
switch (_that) {
case _YearQueryOptions() when $default != null:
return $default(_that);case _:
...
class _YearQueryOptions extends YearQueryOptions with DiagnosticableTreeMixin {
  const _YearQueryOptions({required this.from, required this.to, this.limit = 20}): super._();
...
@pragma('vm:prefer-inline')
_$YearQueryOptionsCopyWith<_YearQueryOptions> get copyWith => __$YearQueryOptionsCopyWithImpl<_YearQueryOptions>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _YearQueryOptions&&(identical(other.from, from) || other.from == from)&&(identical(other.to, to) || other.to == to)&&(identical(other.limit, limit) || other.limit == limit));
}
...
/// @nodoc
abstract mixin class _$YearQueryOptionsCopyWith<$Res> implements $YearQueryOptionsCopyWith<$Res> {
  factory _$YearQueryOptionsCopyWith(_YearQueryOptions value, $Res Function(_YearQueryOptions) _then) = __$YearQueryOptionsCopyWithImpl;
@override @useResult
$Res call({
 DateTime from, DateTime to, int limit
});
