...
extension TimerSettingsHistoryRecordPatterns on TimerSettingsHistoryRecord {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TimerSettingsHistoryRecord value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, TimerSettings timerSettings, int useCount,
            DateTime lastUsed)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _TimerSettingsHistoryRecord() when $default != null:
        return $default(
            _that.id, _that.timerSettings, _that.useCount, _that.lastUsed);
      case _:
        return orElse();
    }
  }
