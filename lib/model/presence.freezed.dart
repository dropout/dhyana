...
mixin _$Presence implements DiagnosticableTreeMixin {
 ...
 String get id; PublicProfile get profile;@DateTimeConverter() DateTime get startedAt;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('id', id))..add(DiagnosticsProperty('profile', profile))..add(DiagnosticsProperty('startedAt', startedAt));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Presence&&(identical(other.id, id) || other.id == id)&&(identical(other.profile, profile) || other.profile == profile)&&(identical(other.startedAt, startedAt) || other.startedAt == startedAt));
}
...
@useResult
$Res call({
 String id, PublicProfile profile,@DateTimeConverter() DateTime startedAt
});
...
/// Create a copy of Presence
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? profile = null,Object? startedAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,profile: null == profile ? _self.profile : profile // ignore: cast_nullable_to_non_nullable
as PublicProfile,startedAt: null == startedAt ? _self.startedAt : startedAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
/// Create a copy of Presence
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  PublicProfile profile, @DateTimeConverter()  DateTime startedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Presence() when $default != null:
return $default(_that.id,_that.profile,_that.startedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  PublicProfile profile, @DateTimeConverter()  DateTime startedAt)  $default,) {final _that = this;
switch (_that) {
case _Presence():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  PublicProfile profile, @DateTimeConverter()  DateTime startedAt)?  $default,) {final _that = this;
switch (_that) {
case _Presence() when $default != null:
return $default(_that.id,_that.profile,_that.startedAt);case _:
  return null;
...
class _Presence extends Presence with DiagnosticableTreeMixin {
  const _Presence({required this.id, required this.profile, @DateTimeConverter() required this.startedAt}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Presence&&(identical(other.id, id) || other.id == id)&&(identical(other.profile, profile) || other.profile == profile)&&(identical(other.startedAt, startedAt) || other.startedAt == startedAt));
}
...
/// Create a copy of Presence
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? profile = null,Object? startedAt = null,}) {
