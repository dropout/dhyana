...
@DurationConverter() Duration get warmup;@DurationConverter() Duration get duration; Sound get startingSound; Sound get endingSound;@DateTimeOrNullConverter() DateTime? get lastUsed;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('warmup', warmup))..add(DiagnosticsProperty('duration', duration))..add(DiagnosticsProperty('startingSound', startingSound))..add(DiagnosticsProperty('endingSound', endingSound))..add(DiagnosticsProperty('lastUsed', lastUsed));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,warmup,duration,startingSound,endingSound,lastUsed);
...
@useResult
$Res call({
@DurationConverter() Duration warmup,@DurationConverter() Duration duration, Sound startingSound, Sound endingSound,@DateTimeOrNullConverter() DateTime? lastUsed
});
...
/// Create a copy of TimerSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? warmup = null,Object? duration = null,Object? startingSound = null,Object? endingSound = null,Object? lastUsed = freezed,}) {
  return _then(_self.copyWith(
warmup: null == warmup ? _self.warmup : warmup // ignore: cast_nullable_to_non_nullable
as Duration,duration: null == duration ? _self.duration : duration // ignore: cast_nullable_to_non_nullable
as Duration,startingSound: null == startingSound ? _self.startingSound : startingSound // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@DurationConverter()  Duration warmup, @DurationConverter()  Duration duration,  Sound startingSound,  Sound endingSound, @DateTimeOrNullConverter()  DateTime? lastUsed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimerSettings() when $default != null:
return $default(_that.warmup,_that.duration,_that.startingSound,_that.endingSound,_that.lastUsed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@DurationConverter()  Duration warmup, @DurationConverter()  Duration duration,  Sound startingSound,  Sound endingSound, @DateTimeOrNullConverter()  DateTime? lastUsed)  $default,) {final _that = this;
switch (_that) {
case _TimerSettings():
return $default(_that.warmup,_that.duration,_that.startingSound,_that.endingSound,_that.lastUsed);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@DurationConverter()  Duration warmup, @DurationConverter()  Duration duration,  Sound startingSound,  Sound endingSound, @DateTimeOrNullConverter()  DateTime? lastUsed)?  $default,) {final _that = this;
switch (_that) {
case _TimerSettings() when $default != null:
return $default(_that.warmup,_that.duration,_that.startingSound,_that.endingSound,_that.lastUsed);case _:
  return null;
...
class _TimerSettings extends TimerSettings with DiagnosticableTreeMixin {
  const _TimerSettings({@DurationConverter() this.warmup = const Duration(minutes: 1), @DurationConverter() this.duration = const Duration(minutes: 10), this.startingSound = Sound.smallBell, this.endingSound = Sound.smallBell, @DateTimeOrNullConverter() this.lastUsed}): super._();
  factory _TimerSettings.fromJson(Map<String, dynamic> json) => _$TimerSettingsFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$TimerSettingsToJson(this, );
}
@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
...
/// Create a copy of TimerSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? warmup = null,Object? duration = null,Object? startingSound = null,Object? endingSound = null,Object? lastUsed = freezed,}) {
