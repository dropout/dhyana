...
mixin _$MilestoneProgress implements DiagnosticableTreeMixin {
 ...
 int get targetDaysCount; List<Session> get sessions;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int completedDaysCount,  int targetDaysCount,  List<Session> sessions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MilestoneProgress() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int completedDaysCount,  int targetDaysCount,  List<Session> sessions)  $default,) {final _that = this;
switch (_that) {
case _MilestoneProgress():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int completedDaysCount,  int targetDaysCount,  List<Session> sessions)?  $default,) {final _that = this;
switch (_that) {
case _MilestoneProgress() when $default != null:
return $default(_that.completedDaysCount,_that.targetDaysCount,_that.sessions);case _:
  return null;
...
class _MilestoneProgress extends MilestoneProgress with DiagnosticableTreeMixin {
  const _MilestoneProgress({this.completedDaysCount = 0, this.targetDaysCount = 7, final  List<Session> sessions = const []}): _sessions = sessions,super._();
