...
extension ProfileEventPatterns on ProfileEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ProfileErrorOccured() when error != null:
        return error(_that);
      case ClearProfileData() when clearData != null:
        return clearData(_that);
      case ValidateProfileStats() when validateProfileStats != null:
        return validateProfileStats(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case UpdateProfile():
        return updateProfile(_that);
      case ProfileErrorOccured():
        return error(_that);
      case ClearProfileData():
        return clearData(_that);
      case ValidateProfileStats():
        return validateProfileStats(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case LoadProfile() when loadProfile != null:
        return loadProfile(
            _that.profileId, _that.profile, _that.onComplete, _that.onError);
      case UpdateProfile() when updateProfile != null:
        return updateProfile(_that.profile, _that.formData, _that.onComplete,
            _that.onError, _that.completeProfile);
      case ProfileErrorOccured() when error != null:
        return error();
      case ClearProfileData() when clearData != null:
        return clearData();
...
extension ProfileStatePatterns on ProfileState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ProfileLoadingState() when loading != null:
        return loading(_that);
      case ProfileLoadedState() when loaded != null:
        return loaded(_that);
      case ProfileErrorState() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
