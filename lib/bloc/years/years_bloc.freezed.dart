...
$YearsEventCopyWith<YearsEvent> get copyWith => _$YearsEventCopyWithImpl<YearsEvent>(this as YearsEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is YearsEvent&&(identical(other.profileId, profileId) || other.profileId == profileId)&&(identical(other.from, from) || other.from == from)&&(identical(other.to, to) || other.to == to));
}
...
abstract mixin class $YearsEventCopyWith<$Res>  {
  factory $YearsEventCopyWith(YearsEvent value, $Res Function(YearsEvent) _then) = _$YearsEventCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$YearsEventCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( QueryYearsEvent value)?  queryYears,required TResult orElse(),}){
final _that = this;
switch (_that) {
case QueryYearsEvent() when queryYears != null:
return queryYears(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( QueryYearsEvent value)  queryYears,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( QueryYearsEvent value)?  queryYears,}){
final _that = this;
switch (_that) {
case QueryYearsEvent() when queryYears != null:
return queryYears(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String profileId,  DateTime from,  DateTime? to)?  queryYears,required TResult orElse(),}) {final _that = this;
switch (_that) {
case QueryYearsEvent() when queryYears != null:
return queryYears(_that.profileId,_that.from,_that.to);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String profileId,  DateTime from,  DateTime? to)  queryYears,}) {final _that = this;
switch (_that) {
case QueryYearsEvent():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String profileId,  DateTime from,  DateTime? to)?  queryYears,}) {final _that = this;
switch (_that) {
case QueryYearsEvent() when queryYears != null:
return queryYears(_that.profileId,_that.from,_that.to);case _:
  return null;
...
@pragma('vm:prefer-inline')
$QueryYearsEventCopyWith<QueryYearsEvent> get copyWith => _$QueryYearsEventCopyWithImpl<QueryYearsEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is QueryYearsEvent&&(identical(other.profileId, profileId) || other.profileId == profileId)&&(identical(other.from, from) || other.from == from)&&(identical(other.to, to) || other.to == to));
}
...
/// @nodoc
abstract mixin class $QueryYearsEventCopyWith<$Res> implements $YearsEventCopyWith<$Res> {
  factory $QueryYearsEventCopyWith(QueryYearsEvent value, $Res Function(QueryYearsEvent) _then) = _$QueryYearsEventCopyWithImpl;
@override @useResult
$Res call({
 String profileId, DateTime from, DateTime? to
});
