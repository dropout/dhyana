...
extension WeeksEventPatterns on WeeksEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case GetWeeksEvent() when queryWeeks != null:
        return queryWeeks(_that);
      case ReceiveUpdateWeeksEvent() when receiveUpdate != null:
        return receiveUpdate(_that);
      case WeeksErrorEvent() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case GetWeeksEvent():
        return queryWeeks(_that);
      case ReceiveUpdateWeeksEvent():
        return receiveUpdate(_that);
      case WeeksErrorEvent():
        return error(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ReceiveUpdateWeeksEvent() when receiveUpdate != null:
        return receiveUpdate(_that.weeks);
      case WeeksErrorEvent() when error != null:
        return error();
      case _:
        return orElse();
...
extension WeeksStatePatterns on WeeksState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case WeeksLoadedState() when loaded != null:
        return loaded(_that);
      case WeeksLoadingErrorState() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case WeeksLoadingState() when loading != null:
        return loading();
      case WeeksLoadedState() when loaded != null:
        return loaded(_that.from, _that.to, _that.weeks, _that.calculatedStats);
      case WeeksLoadingErrorState() when error != null:
        return error();
      case _:
        return orElse();
