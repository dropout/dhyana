...
mixin _$SessionCompletedEvent {
 ...
 String get profileId; Session get session; void Function(UpdateProfileStatsResult updateResults)? get onComplete; void Function(Object? error, StackTrace stack)? get onError;
/// Create a copy of SessionCompletedEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SessionCompletedEventCopyWith<SessionCompletedEvent> get copyWith => _$SessionCompletedEventCopyWithImpl<SessionCompletedEvent>(this as SessionCompletedEvent, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SessionCompletedEvent&&(identical(other.profileId, profileId) || other.profileId == profileId)&&(identical(other.session, session) || other.session == session)&&(identical(other.onComplete, onComplete) || other.onComplete == onComplete)&&(identical(other.onError, onError) || other.onError == onError));
}


@override
int get hashCode => Object.hash(runtimeType,profileId,session,onComplete,onError);
...
abstract mixin class $SessionCompletedEventCopyWith<$Res>  {
  factory $SessionCompletedEventCopyWith(SessionCompletedEvent value, $Res Function(SessionCompletedEvent) _then) = _$SessionCompletedEventCopyWithImpl;
@useResult
$Res call({
 String profileId, Session session, void Function(UpdateProfileStatsResult updateResults)? onComplete, void Function(Object? error, StackTrace stack)? onError
});
...
/// Create a copy of SessionCompletedEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? profileId = null,Object? session = null,Object? onComplete = freezed,Object? onError = freezed,}) {
  return _then(_self.copyWith(
profileId: null == profileId ? _self.profileId : profileId // ignore: cast_nullable_to_non_nullable
as String,session: null == session ? _self.session : session // ignore: cast_nullable_to_non_nullable
as Session,onComplete: freezed == onComplete ? _self.onComplete : onComplete // ignore: cast_nullable_to_non_nullable
as void Function(UpdateProfileStatsResult updateResults)?,onError: freezed == onError ? _self.onError : onError // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LogSessionEvent value)?  logSession,required TResult orElse(),}){
final _that = this;
switch (_that) {
case LogSessionEvent() when logSession != null:
return logSession(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LogSessionEvent value)  logSession,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LogSessionEvent value)?  logSession,}){
final _that = this;
switch (_that) {
case LogSessionEvent() when logSession != null:
return logSession(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String profileId,  Session session,  void Function(UpdateProfileStatsResult updateResults)? onComplete,  void Function(Object? error, StackTrace stack)? onError)?  logSession,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LogSessionEvent() when logSession != null:
return logSession(_that.profileId,_that.session,_that.onComplete,_that.onError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String profileId,  Session session,  void Function(UpdateProfileStatsResult updateResults)? onComplete,  void Function(Object? error, StackTrace stack)? onError)  logSession,}) {final _that = this;
switch (_that) {
case LogSessionEvent():
return logSession(_that.profileId,_that.session,_that.onComplete,_that.onError);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String profileId,  Session session,  void Function(UpdateProfileStatsResult updateResults)? onComplete,  void Function(Object? error, StackTrace stack)? onError)?  logSession,}) {final _that = this;
switch (_that) {
case LogSessionEvent() when logSession != null:
return logSession(_that.profileId,_that.session,_that.onComplete,_that.onError);case _:
  return null;
...
class LogSessionEvent extends SessionCompletedEvent {
  const LogSessionEvent({required this.profileId, required this.session, this.onComplete, this.onError}): super._();
  

@override final  String profileId;
@override final  Session session;
@override final  void Function(UpdateProfileStatsResult updateResults)? onComplete;
@override final  void Function(Object? error, StackTrace stack)? onError;

/// Create a copy of SessionCompletedEvent
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LogSessionEventCopyWith<LogSessionEvent> get copyWith => _$LogSessionEventCopyWithImpl<LogSessionEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LogSessionEvent&&(identical(other.profileId, profileId) || other.profileId == profileId)&&(identical(other.session, session) || other.session == session)&&(identical(other.onComplete, onComplete) || other.onComplete == onComplete)&&(identical(other.onError, onError) || other.onError == onError));
}
...
/// @nodoc
abstract mixin class $LogSessionEventCopyWith<$Res> implements $SessionCompletedEventCopyWith<$Res> {
  factory $LogSessionEventCopyWith(LogSessionEvent value, $Res Function(LogSessionEvent) _then) = _$LogSessionEventCopyWithImpl;
@override @useResult
$Res call({
 String profileId, Session session, void Function(UpdateProfileStatsResult updateResults)? onComplete, void Function(Object? error, StackTrace stack)? onError
});
...
/// Create a copy of SessionCompletedEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? profileId = null,Object? session = null,Object? onComplete = freezed,Object? onError = freezed,}) {
