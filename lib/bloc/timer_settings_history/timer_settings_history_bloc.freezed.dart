...
extension TimerSettingsHistoryEventPatterns on TimerSettingsHistoryEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case SaveTimerSettingsHistoryEvent() when saveSettings != null:
        return saveSettings(_that);
      case LoadTimerSettingsHistoryEvent() when loadSettingsList != null:
        return loadSettingsList(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case _Started():
        return started(_that);
      case SaveTimerSettingsHistoryEvent():
        return saveSettings(_that);
      case LoadTimerSettingsHistoryEvent():
        return loadSettingsList(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case _Started() when started != null:
        return started();
      case SaveTimerSettingsHistoryEvent() when saveSettings != null:
        return saveSettings(_that.profileId, _that.timerSettings);
      case LoadTimerSettingsHistoryEvent() when loadSettingsList != null:
        return loadSettingsList(_that.profileId);
      case _:
        return orElse();
    }
  }
...
extension TimerSettingsHistoryStatePatterns on TimerSettingsHistoryState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case TimerSettingsHistoryLoading() when loading != null:
        return loading(_that);
      case TimerSettingsHistoryLoaded() when loaded != null:
        return loaded(_that);
      case TimerSettingsHistoryError() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case TimerSettingsHistoryLoading() when loading != null:
        return loading();
      case TimerSettingsHistoryLoaded() when loaded != null:
        return loaded(_that.timerSettingsList);
      case TimerSettingsHistoryError() when error != null:
        return error();
      case _:
        return orElse();
