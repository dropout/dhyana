...
extension PresenceEventPatterns on PresenceEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case LoadPresenceData() when load != null:
        return load(_that);
      case LoadMorePresenceData() when loadMore != null:
        return loadMore(_that);
      case ShowPresence() when showPresence != null:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case LoadPresenceData() when load != null:
        return load(
            _that.ownProfileId, _that.intervalInMinutes, _that.batchSize);
      case LoadMorePresenceData() when loadMore != null:
        return loadMore(
            _that.lastDocumentId, _that.intervalInMinutes, _that.batchSize);
      case ShowPresence() when showPresence != null:
...
extension PresenceStatePatterns on PresenceState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case PresenceLoadingState() when loading != null:
        return loading(_that);
      case PresenceLoadingMoreState() when loadingMore != null:
        return loadingMore(_that);
      case PresenceLoadedState() when loaded != null:
        return loaded(_that);
      case PresenceErrorState() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case PresenceLoadingState() when loading != null:
        return loading();
      case PresenceLoadingMoreState() when loadingMore != null:
        return loadingMore(_that.presenceList);
      case PresenceLoadedState() when loaded != null:
        return loaded(_that.presenceList);
      case PresenceErrorState() when error != null:
        return error();
      case _:
        return orElse();
