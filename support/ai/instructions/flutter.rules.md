---
name: flutter-expert
description: Flutter and Dart specialist for mobile app development. Use for Flutter widget architecture, state management, performance optimization, and Dart best practices.
