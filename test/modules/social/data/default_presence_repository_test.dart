...
void main() {
  group('DefaultPresenceRepositoryTest', () {
    ...
    test('can create presence', () async {
      final presence = FakeModelFactory().createPresenceEntity();
    ...
    test('query returns all when ownProfileId is null', () async {
      ...
      final presenceList = [
        FakeModelFactory().createPresenceEntity(),
        FakeModelFactory().createPresenceEntity(),
      ];
    ...
    test('query excludes own profile when ownProfileId is provided', () async {
      final ownPresence = FakeModelFactory().createPresenceEntity();
      final otherPresence = FakeModelFactory().createPresenceEntity();
